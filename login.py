...
def login_user():
    if usernameEntry.get()=='' or passwordEntry.get()=='':  
        ...
        try:
            con=pymysql.connect(host='ENTER YOUR HOST NAME',user='ENTER YOUR USER NAME',password='ENTER YOUR PASSWORD')      # Creating connection with MySQL server
        ...
        if row==None:
            ...
            try:
                con=pymysql.connect(host='ENTER YOUR HOST NAME',user='ENTER YOUR USER NAME',password='ENTER YOUR PASSWORD') # Creating a connection with mysql server
                mycursor=con.cursor()
                ...
                con=pymysql.connect(host='ENTER YOUR HOST NAME',user='ENTER YOUR USER NAME',password='ENTER YOUR PASSWORD')  
                mycursor=con.cursor()
